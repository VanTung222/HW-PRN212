...
namespace DelegatesLinQ.Homework
{
    ...
    public class EventCalculator
    {
        ...
        public double Add(double a, double b)
        {
            ...
            double result = a + b;
            OperationPerformed?.Invoke("Add", a, b, result);
            return result;
        }
        ...
        public double Subtract(double a, double b)
        {
            ...
            double result = a - b;
            OperationPerformed?.Invoke("Subtract", a, b, result);
            return result;
        }
        ...
        public double Multiply(double a, double b)
        {
            ...
            double result = a * b;
            OperationPerformed?.Invoke("Multiply", a, b, result);
            return result;
        }
        ...
        public double Divide(double a, double b)
        {
            ...
            if (b == 0)
            {
                ...
                ErrorOccurred?.Invoke("Divide", errorMessage);
                return double.NaN; // Return NaN to indicate an error
            }
            else
            {
                double result = a / b;
                OperationPerformed?.Invoke("Divide", a, b, result);
                return result;
            }
        }
    ...
    public class ErrorHandler
    {
        ...
        public void OnErrorOccurred(string operation, string errorMessage)
        {
            Console.WriteLine($"[ERROR] Operation: {operation}, Message: {errorMessage}");
        }
    }
